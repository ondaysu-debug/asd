...
class Config:
    ...
    # APIs
    # CMC DEX (primary)
    # Note: default base uses older 'dexer/v3' path for broad compatibility.
    # If your CMC plan supports v4, you may set CMC_DEX_BASE accordingly.
    cmc_dex_base: str = "https://api.coinmarketcap.com/dexer/v3"
    cmc_dex_base_alt: str = "https://pro-api.coinmarketcap.com/dexer/v3"
    cmc_api_key: str = ""
    ...
    # Filters
    liquidity_min: float = 50_000.0
    liquidity_max: float = 800_000.0
    tx24h_max: int = 2000
    chains: List[str] = field(default_factory=lambda: ["base", "solana", "ethereum", "bsc"])
    ...
    # CMC chain slug mapping (allows bsc->bnb etc.)
    chain_slugs: Dict[str, str] = field(
        default_factory=lambda: {
            "base": "base",
            "ethereum": "ethereum",
            "solana": "solana",
            # Per CMC docs some endpoints use 'bnb' instead of 'bsc'
            "bsc": "bnb",
        }
    )
